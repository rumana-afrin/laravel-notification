            ...
            <div class="col-xl-5">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        <img src="{{ !empty($user_data->image) ? asset('storage/' . $user_data->image) : asset('assets/img/no-imge.jpg') }}"
                    ...
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-8 admin-profile">{{ $user_data->name }}</div>
                        </div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-9 col-md-8 admin-profile">{{ $user_data->phone }}</div>
                        </div>

                        <div class="row mt-3">
                            <div class="col-lg-3 col-md-4 label admin-profile">Email</div>
                            <div class="col-lg-9 col-md-8 admin-profile">{{ $user_data->email }}</div>
                        </div>
                    </div>
                </div>
                                ...
                                <form method="POST" action="{{route('user.update')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="username" type="text" class="form-control admin-profile"
                                                id="name" value="{{ $user_data->username }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="phone" type="text" class="form-control admin-profile"
                                                id="Phone" value="{{ $user_data->phone }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="email" type="email" class="form-control admin-profile"
                                                id="Email" value="{{ $user_data->email }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="upload-img-box mb-25">
                                            <img id="showImage" src="{{ !empty($user_data->image) ? asset('storage/' . $user_data->image) : getDefaultImage() }}">
